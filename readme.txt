...
Dans la page d’accueil j’ai intégré la barre de navigation qui se compose de la bibliothèque des séries et le compte utilisateur (qui constitue d’une menue ; déconnexion(deconnecter.php) +le profil (profil. PHP)), et je mis en place une petite touche de mise en page avec CSS(style.css) ;
